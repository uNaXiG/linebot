...
if __name__ == "__main__":   
    ...
    path = os.path.join(os.getcwd(), 'Weather', f"{datetime.datetime.now().strftime('%Y_%m_%d')}_data")
    ...
    save_file_name = os.path.join(path, f"{datetime.datetime.now().strftime('weather_report')}_data.csv")
